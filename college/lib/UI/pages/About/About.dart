                                        ...
                                        IconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              if (member[index].name ==
                                                  "Aastha Singh") {
                                                launch(
                                                    'https://www.facebook.com/profile.php?id=100009696422991');
                                              }
                                            }),
                                        IconButton(
                                            icon:
                                            ...
                                            onPressed: () {
                                              ...
                                              if (member[index].name ==
                                                  "Aastha Singh") {
                                                launch(
                                                    'https://github.com/aasthasingh650');
                                              }
                                            }),
                                        IconButton(
                                            icon: FaIcon(
                                            ...
                                            onPressed: () {
                                              ...
                                              if (member[index].name ==
                                                  "Aastha Singh") {
                                                launch(
                                                    'https://www.linkedin.com/in/aastha-singh-18000a197/');
                                              }
                                            }),
                                      ],
                                    ),
