...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  fetchDatabaseList() async {
    dynamic resultant = await DatabaseManager().getUsersList('STUDENT');
    if (resultant == null) {
  ...
  submitAction(BuildContext context) {
    updateData('STUDENT',nameController.text, rollNoController.text,semesterController.text,courseController.text,branchController.text,batchController.text, userID);
